...
class BuildExe:
    def __init__(self):
        #Name of starting .py
        self.script = "mainMenu.py"

        #Name of program
        self.project_name = "boxing"

        #Project url
        self.project_url = "about:https://ffists6.deviantart.com"
        ...
        #Auhor of program
        self.author_name = "ffists7"
        self.author_email = ""
        self.copyright = ""

        #Description
        self.project_description = "ffists7's boxing sim"
